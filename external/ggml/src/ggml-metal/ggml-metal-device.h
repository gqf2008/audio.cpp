...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_snake_1d         (ggml_metal_library_t lib, const struct ggml_tensor * op);
...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_mul_mm_acc        (ggml_metal_library_t lib, const struct ggml_tensor * op);
...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_bin_bcast         (ggml_metal_library_t lib, const struct ggml_tensor * op);
...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_conv_transpose_2d_linear (ggml_metal_library_t lib, const struct ggml_tensor * op);
...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_pad_left          (ggml_metal_library_t lib, const struct ggml_tensor * op);
